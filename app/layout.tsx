  ...
  return (
    <html lang="zh-Hant">
      <body style={{ margin: 0, fontFamily: 'system-ui, -apple-system, sans-serif', background: '#f5f5f5' }}>
        <header className="no-print" style={{ background: '#003366', color: 'white', padding: '12px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
          ...
          <nav style={{ display: 'flex', gap: '12px', fontSize: '14px', flexWrap: 'wrap' }}>
            ...
            <a href="/guide" style={{ color: '#bbdefb', textDecoration: 'none' }}>📖 指南</a>
